...
Структура файла ПАМ (расширение .pam):
```
[pam_header]                — заголовок (магия, версия, размер области данных,
                              число именованных слотов, ёмкость слотов)
[slot_descriptor * cap]     — динамическая таблица именованных дескрипторов
...
**Ключевые типы:**
- `slot_descriptor` — дескриптор именованного объекта (смещение, размер, тип, имя)
