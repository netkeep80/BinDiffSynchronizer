 ...
 *
 * Этот файл содержит PMM-версию примитива персистного массива,
 * совместимую по API с оригинальным pmem_array.h.
 *
 ...
 *
 * Формат данных:
 *   pmem_array_hdr — структура заголовка (без изменений):
...
// ═══════════════════════════════════════════════════════════════════════════
// pmem_array_hdr_pmm — заголовок персистного массива (совместим с pmem_array_hdr)
// ═══════════════════════════════════════════════════════════════════════════

/**
 * @brief Заголовок персистного массива для PMM.
 *
 * Раскладка идентична оригинальному pmem_array_hdr для совместимости:
 *   [size | capacity | data_off]  — 3 * sizeof(uintptr_t)
 *
 * data_off хранит байтовое смещение (не гранульный индекс) для совместимости
 * с существующим кодом и node_id.
 */
 ...
 *
 * Примечание: PMM не поддерживает realloc на месте (в отличие от оригинального ПАМ),
