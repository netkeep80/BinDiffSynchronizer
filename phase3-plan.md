...
**Status:** TODO — Plan Approved, Implementation Not Started
...
Файл: `experiments/benchmark_persist_vs_std.cpp`
...
- [ ] 3.1.1: `persist<_T>` — исправлен, задокументирован, покрыт тестами (≥6 тестов).
- [ ] 3.1.2: `fptr<_T>` — исправлен, задокументирован, покрыт тестами (≥6 тестов).
- [ ] 3.1.3: `AddressManager<_T>` — исправлен, задокументирован, покрыт тестами (≥6 тестов).
- [ ] 3.1.4: `Cache` — исправлен (`Flush` добавлен), покрыт тестами (≥9 тестов).
- [ ] 3.1.5: `MemoryDevice` — исправлен, покрыт тестами (≥5 тестов).
- [ ] 3.1.6: `StaticPageDevice` — исправлен, покрыт тестами (≥4 тестов).
