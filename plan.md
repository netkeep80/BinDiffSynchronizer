...
### Задача 15.2. Консолидация `pvector.h` и `pvector_pmm.h`

**Цель:** Устранить дублирование кода динамического массива.

- [ ] Сохранить `pvector_pmm.h` как каноническую реализацию.
- [ ] Преобразовать `pvector.h` в тонкую обёртку с `using`-алиасами.
- [ ] Обновить все тесты.
- [ ] Прогнать все тесты.
