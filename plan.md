...
Этап 13: Обновление PMM до последней версии
  13.1  ✅ Обновление deps/pmm/pmm.h с v0.45.0 до v0.47.0
       Изменения в PMM v0.47.0: удалён тип pvector (полностью заменён на parray)
       → тесты: все 715 тестов проходят
```
...
| Дата | Изменение |
|------|-----------|
| 2026-03-22 | Этап 13.1: обновление PMM с v0.45.0 до v0.47.0 — удалён pvector, заменён на parray (Issue #211) |
