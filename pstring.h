...
struct pstring
{
    ...
    bool operator<( const pstring& other ) const { return std::strcmp( c_str(), other.c_str() ) < 0; }
...
static_assert( sizeof( pstring::length ) == sizeof( void* ), "pstring::length должен иметь размер void* (Phase 3)" );
