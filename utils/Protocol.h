...
template <typename _T> struct argument
{
    typedef _T type;
};
    ...
    {                                                                                                                  \
      private:                                                                                                         \
        ...
        Name##Protocol* Receiver;                                                                                      \
                                                                                                                       \
      protected:                                                                                                       \
        Name##Protocol() : Receiver( NULL ) {}                                                                         \
        ~##Name##Protocol() {}                                                                                         \
                                                                                                                       \
      public:                                                                                                          \
        void Connect( Name##Protocol* Receiver )                                                                       \
        {                                                                                                              \
        ...
        virtual void Exception( const char* which_protocol, const char* which_method )                                 \
        {                                                                                                              \
            Receiver = NULL;                                                                                           \
        }
...
#define HostProtocol( Name )                                                                                           \
    Name##HostProtocol                                                                                                 \
    {                                                                                                                  \
      private:                                                                                                         \
        const char* ProtocolName() const                                                                               \
        {                                                                                                              \
            return "##Name##HostProtocol";                                                                             \
        }                                                                                                              \
        Name##HostProtocol* Receiver;                                                                                  \
                                                                                                                       \
      protected:                                                                                                       \
        Name##HostProtocol( Name##HostProtocol* HostReceiver = NULL ) : Receiver( HostReceiver ) {}                    \
        ~##Name##HostProtocol() {}                                                                                     \
        virtual void Exception( const char* which_protocol, const char* which_method )                                 \
        {                                                                                                              \
            Receiver = NULL;                                                                                           \
