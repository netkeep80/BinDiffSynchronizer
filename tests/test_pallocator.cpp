...
// ---------------------------------------------------------------------------
TEST_CASE( "pallocator<int>: satisfies STL allocator type requirements", "[pallocator][layout]" )
{
...
// ---------------------------------------------------------------------------
TEST_CASE( "pallocator<int>: rebind<double> gives pallocator<double>", "[pallocator][rebind]" )
{
...
// ---------------------------------------------------------------------------
TEST_CASE( "pallocator<int>: default and copy constructor work", "[pallocator][construct]" )
{
    pallocator<int> a1;
...
// ---------------------------------------------------------------------------
TEST_CASE( "pallocator: cross-type copy constructor compiles", "[pallocator][construct]" )
{
    pallocator<int>    ai;
...
// ---------------------------------------------------------------------------
TEST_CASE( "pallocator<int>: max_size() returns a positive value", "[pallocator][max_size]" )
{
    pallocator<int> a;
...
// ---------------------------------------------------------------------------
TEST_CASE( "pallocator: any two pallocator instances compare equal", "[pallocator][equality]" )
{
    pallocator<int> a1;
    pallocator<int> a2;
    REQUIRE( a1 == a2 );
