...
// ---------------------------------------------------------------------------
TEST_CASE("persist<T>: sizeof(persist<T>) == sizeof(T) (Tr.8)",
          "[persist][layout]")
{
...
// ---------------------------------------------------------------------------
TEST_CASE("fptr<T>: sizeof(fptr<T>) == sizeof(void*) (Tr.5)",
          "[fptr][layout]")
{
...
// ---------------------------------------------------------------------------
TEST_CASE("fptr<T>: is trivially copyable",
          "[fptr][layout]")
{
...
// ---------------------------------------------------------------------------
TEST_CASE("fptr<int>: set_addr and addr -- get and set offset",
          "[fptr]")
{
    fptr<int> p;
    REQUIRE(p.addr() == 0u);
...
// ---------------------------------------------------------------------------
TEST_CASE("AddressManager<int>: FindByPtr returns offset by pointer",
          "[address_manager]")
{
...
// ---------------------------------------------------------------------------
TEST_CASE("fptr<int>: find() initializes by object name (Tr.15)",
          "[fptr][find]")
{
